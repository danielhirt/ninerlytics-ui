...
export class HeatMapComponent implements OnInit {
  ...
  url: SafeResourceUrl = this.sanitizer.bypassSecurityTrustResourceUrl("http://www.campusheatmap.com:3000/d-solo/DfLdEI-Zz/new-dashboard-copy-2?orgId=1&from=" + this.event1 + "&to=" + this.event2 + "&panelId=2");
  ...
  setURL(){
    ...
    if(date1 < date2){
      let temp: string = "http://www.campusheatmap.com:3000/d-solo/DfLdEI-Zz/new-dashboard-copy-2?orgId=1&from=" + this.event1 + "&to=" + this.event2 + "&panelId=2";
